...
[sad0p@arch-deliberate d0zer-payloads]$ ./shellcode.py payload.bin
"b'b8 00 00 00 00 e8 08 00 00 00 e9 b2 00 00 00 90 0f 0b 55 48 89 e5 48 83 ec 20 48 b8 4a 75 73 74 20 61 20 74 48 ba 65 73 74 20 6d 61 6e 20 48 89 45 e0 48 89 55 e8 c7 45 f0 21 21 0a 00 48 8d 45 e0 48 89 c7 e8 17 00 00 00 48 89 c2 48 8d 45 e0 48 89 c6 bf 01 00 00 00 e8 33 00 00 00 90 c9 c3 55 48 89 e5 48 89 7d e8 48 c7 45 f8 00 00 00 00 eb 05 48 83 45 f8 01 48 8b 45 e8 48 8d 50 01 48 89 55 e8 0f b6 00 84 c0 75 e8 48 8b 45 f8 5d c3 55 48 89 e5 89 7d ec 48 89 75 e0 48 89 55 d8 48 c7 c0 01 00 00 00 48 8b 7d ec 48 8b 75 e0 48 8b 55 d8 0f 05 48 89 c0 48 89 45 f8 48 8b 45 f8 5d c3 90 0f 0b'
"
[sad0p@arch-deliberate d0zer-payloads]$ #ommit the last three bytes, copy and paste the rest into cyberchef with hex-to-hex translator with the second translator with \x delimitor
